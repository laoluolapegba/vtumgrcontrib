...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class KedcoPostpaidController : Controller
    {
        private readonly ILogger<KedcoPostpaidController> _logger;
        ...
        public KedcoPostpaidController(
            ILogger<KedcoPostpaidController> logger,
