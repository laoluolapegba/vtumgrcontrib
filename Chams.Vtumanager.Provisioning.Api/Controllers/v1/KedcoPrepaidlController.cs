...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class KedcoPrepaidlController : Controller
    {
        private readonly ILogger<KedcoPrepaidlController> _logger;
        ...
        public KedcoPrepaidlController(
            ILogger<KedcoPrepaidlController> logger,
