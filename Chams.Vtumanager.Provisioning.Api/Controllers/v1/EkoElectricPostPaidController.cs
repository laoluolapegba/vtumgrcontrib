...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class EkoElectricPostPaidController : Controller
    {
        private readonly ILogger<EkoElectricPostPaidController> _logger;
        ...
        public EkoElectricPostPaidController(
            ILogger<EkoElectricPostPaidController> logger,
