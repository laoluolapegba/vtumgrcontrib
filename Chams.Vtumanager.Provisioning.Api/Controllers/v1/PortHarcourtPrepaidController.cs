...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class PortHarcourtPrepaidController : Controller
    {
        private readonly ILogger<PortHarcourtPrepaidController> _logger;
        ...
        public PortHarcourtPrepaidController(
            ILogger<PortHarcourtPrepaidController> logger,
