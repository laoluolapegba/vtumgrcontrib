...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class KadunaPrepaidController : Controller
    {
        private readonly ILogger<KadunaPrepaidController> _logger;
        ...
        public KadunaPrepaidController(
            ILogger<KadunaPrepaidController> logger,
