...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class SmileBundleController : Controller
    {
        private readonly ILogger<SmileBundleController> _logger;
        ...
        public SmileBundleController(
            ILogger<SmileBundleController> logger,
