...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class EkoElectricPrePaidController : Controller
    {
        private readonly ILogger<EkoElectricPrePaidController> _logger;
        ...
        public EkoElectricPrePaidController(
            ILogger<EkoElectricPrePaidController> logger,
