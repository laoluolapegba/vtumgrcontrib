...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class JosElectricPrepaidController : Controller
    {
        private readonly ILogger<JosElectricPrepaidController> _logger;
        ...
        public JosElectricPrepaidController(
            ILogger<JosElectricPrepaidController> logger,
