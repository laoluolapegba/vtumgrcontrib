...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class SpectranetPaymentRefillController : Controller
    {
        private readonly ILogger<SpectranetPaymentRefillController> _logger;
        ...
        public SpectranetPaymentRefillController(
            ILogger<SpectranetPaymentRefillController> logger,
