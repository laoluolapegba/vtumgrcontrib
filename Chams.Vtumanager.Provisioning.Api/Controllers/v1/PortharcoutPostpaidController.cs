...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class PortharcoutPostpaidController : Controller
    {
        private readonly ILogger<PortharcoutPostpaidController> _logger;
        ...
        public PortharcoutPostpaidController(
            ILogger<PortharcoutPostpaidController> logger,
