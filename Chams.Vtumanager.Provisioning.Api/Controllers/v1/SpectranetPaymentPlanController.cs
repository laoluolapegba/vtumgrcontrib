...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class SpectranetPaymentPlanController : Controller
    {
        private readonly ILogger<SpectranetPaymentPlanController> _logger;
        ...
        public SpectranetPaymentPlanController(
            ILogger<SpectranetPaymentPlanController> logger,
