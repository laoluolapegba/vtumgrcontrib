...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class SpectranetPINController : Controller
    {
        private readonly ILogger<SpectranetPINController> _logger;
        ...
        public SpectranetPINController(
            ILogger<SpectranetPINController> logger,
