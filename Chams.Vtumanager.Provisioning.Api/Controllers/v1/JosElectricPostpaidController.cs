...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class JosElectricPostpaidController : Controller
    {
        private readonly ILogger<JosElectricPostpaidController> _logger;
        ...
        public JosElectricPostpaidController(
            ILogger<JosElectricPostpaidController> logger,
